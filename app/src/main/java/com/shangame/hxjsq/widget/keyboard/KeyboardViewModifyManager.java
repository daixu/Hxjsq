...
public class KeyboardViewModifyManager implements KeyboardView.OnKeyboardActionListener {
    //数字键盘标记
    ...
    private KeyboardViewModifyManager() {
        //创建打气筒
     ...
     * @return
     */
    public KeyboardViewModifyManager addKeyboardView(FrameLayout rootView) {
    ...
    public static final class Builder {
        ...
        public KeyboardViewModifyManager build(Context context) {
            mContext = context;
            return new KeyboardViewModifyManager();
        }
    }
}
